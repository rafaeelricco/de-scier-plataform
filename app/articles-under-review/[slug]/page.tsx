                     ...
                     {authors_mock.map((item, index) => (
                        <div key={item.id}>
                           <div className="grid grid-cols-5  items-center px-0 py-3 rounded-md">
                              ...
                              <div>
                                 <p className="text-sm text-secundary_blue-main first-letter:uppercase">{item.role}</p>
                              </div>
                              <div>
                                 <p className="text-sm text-secundary_blue-main first-letter:uppercase">{item.status}</p>
                              </div>
                           </div>
                        </div>
                     ))}
