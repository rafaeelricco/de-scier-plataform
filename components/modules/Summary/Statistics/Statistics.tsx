      ...
      <React.Fragment>
         <div className="grid grid-flow-col items-center gap-4">
            ...
            <div ref={sliderRef} className="keen-slider">
               {carrousel.map((c) => (
                  <div key={c.id} className={`keen-slider__slide slider-${c.id}`}>
                     {c.component}
                  </div>
               ))}
            </div>
...
const TotalArticles: React.FC<{ total_articles: number }> = ({ total_articles }) => {
   return (
      <div className="grid grid-flow-col justify-center items-center">
         <StatisticsIllustration className="w-full max-w-[15rem] mx-auto my-0" />
...
const TotalLikes: React.FC<{ total_likes: number }> = ({ total_likes }) => {
   return (
      <div className="grid grid-flow-col justify-center items-center">
         <LikesIllustration className="w-full max-w-[15rem] mx-auto my-0" />
         <div className="grid justify-items-center content-center">
...
const TotalViews: React.FC<{ total_views: number }> = ({ total_views }) => {
   return (
      <div className="grid grid-flow-col justify-center items-center">
         <ViewsIllustration className="w-full max-w-[15rem] mx-auto my-0" />
         <div className="grid justify-items-center content-center">
